 ...
 * 2. Run this test: node examples/test-connection.js (after build)
 *    or: npx tsx examples/test-connection.ts
 */

import WebSocket from 'ws'

// For Node.js, we need to provide WebSocket implementation
// @ts-expect-error - global WebSocket for Node.js
globalThis.WebSocket = WebSocket

// Use relative path for tsx to work with workspace packages
